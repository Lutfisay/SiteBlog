<%@ Page Title="" Language="C#" MasterPageFile="~/kullanici.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="Sitem._default" %>
...
<asp:Content ID="Content2" runat="server" contentplaceholderid="ContentPlaceHolder1">
    <div style="width:690px;height:auto;margin:0 auto;">
        <asp:DataList ID="dl_mkale" runat="server" Width="690px" OnSelectedIndexChanged="dl_mkale_SelectedIndexChanged">
            <ItemTemplate>
